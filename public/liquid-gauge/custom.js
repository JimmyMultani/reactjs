...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var gauge, radius, locationX, locationY, fillPercent, wave, waveAnimateScale, text1, text2, text3, text4, waveHeightScale;
    var textPixels, textFinalValue, textStartValue, percentText, textRiseScaleY;
    var textRounder = function(value){ return Math.round(value); };
    var circleThickness, circleFillGap, fillCircleMargin, fillCircleRadius, fillCircleGroup, waveHeight, waveLength, waveClipCount, waveClipWidth;
    var waveGroup, waveGroupXPosition, waveGroupYPosition, data, gaugeCircleX, gaugeCircleY, waveScaleX, waveScaleY, waveRiseScale;
    var gaugeGroup, gaugeCircleArc, clipArea;
    ...
    function render() {
        ...
        text3 = gaugeGroup.append("text")
            .text('Entries')
            .attr("class", "liquidFillGaugeTextSmall")
            .attr("text-anchor", "middle")
            .attr("font-size", textPixels + "px")
            .style("fill", config.textColor)
            .attr('transform','translate('+radius+','+textRiseScaleY(config.textVertPosition - 0.3)+')');
        ...
        text4 = fillCircleGroup.append("text")
            .text('Entries')
            .attr("class", "liquidFillGaugeTextSmall")
            .attr("text-anchor", "middle")
            .attr("font-size", textPixels + "px")
    ...
    function GaugeUpdater() {
        this.resize = function() {
            ...
            text1.attr('transform','translate('+radius+','+textRiseScaleY(config.textVertPosition)+')');
            text2.attr('transform','translate('+radius+','+textRiseScaleY(config.textVertPosition)+')');
            text3.attr('transform','translate('+radius+','+textRiseScaleY(config.textVertPosition - 0.3)+')');
            text4.attr('transform','translate('+radius+','+textRiseScaleY(config.textVertPosition - 0.3)+')');

            var elem = document.getElementById('fillgauge'),
                circle = elem.getElementsByTagName('circle')[0];

            circle.setAttribute("cx", radius);
            circle.setAttribute("cy", radius);
            circle.setAttribute("r", fillCircleRadius);
        ...
        this.update = function(value) {
            ...
            // document.getElementById('fillgauge').innerHTML = '';
            // render();
        }
    }
